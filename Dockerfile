...
RUN R -e "devtools::install_version('lme4', version = '1.1-35.1', dependencies = T)"
RUN R -e "devtools::install_version('insight', version = '0.19.8', dependencies = T)"
...
RUN R -e "devtools::install_version('Matrix', version = '1.6-5', dependencies = T)"