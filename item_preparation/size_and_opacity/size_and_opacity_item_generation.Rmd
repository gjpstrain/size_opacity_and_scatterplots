---
title: "size_and_opacity_item_generation"
...
```{r}
plot_function <- function(slopes, my_desired_r, letter, size_value, opacity_value) {
...
```{r}
size_and_opacity_items <- rbind(data_with_sizes, attention_checks) %>%
  cbind(masks_with_labels)

write.csv(size_and_opacity_items, "exp_size_and_opacity_full_data.csv", row.names = FALSE)
```
