...
scatterplots to correct for a well-known bias. We combine two techniques
...
\includegraphics[width=1\textwidth,height=\textheight]{size_and_contrast_files/figure-pdf/fig-examples-1.pdf} \hfill{}
...
\midrule
TO Size x IO Contrast <-> IO Size x IO Contrast & -10.95 & <0.001\\
TO Size x IO Contrast <-> TO Size x TO Contrast & 72.29 & <0.001\\
TO Size x IO Contrast <-> IO Size x TO Contrast & -2.26 & 0.108\\
IO Size x IO Contrast <-> TO Size x TO Contrast & 46.13 & <0.001\\
IO Size x IO Contrast <-> IO Size x TO Contrast & 17.84 & <0.001\\
\addlinespace
TO Size x TO Contrast <-> IO Size x TO Contrast & -37.44 & <0.001\\
\bottomrule
\end{tabular}
\end{table}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{size_and_contrast_files/figure-pdf/fig-time-plot-1.pdf}
...
observed effect in the standard orientation congruent condition were due
