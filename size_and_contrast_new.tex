...
to change viewers' perceptions of data visualizations. Additionally, we
use our results to further explain the perceptual mechanisms at play
when changing point size and contrast in scatterplots.    
\end{abstract}
...
accuracy of those interpretations is generally low. In particular,
...
that the combined effect is stronger than being simply linearly
additive. Building on this, we present a framework for visualization
...
increased. This performance on a discrimination judgement tasks can also
...
finding implies that the center of the scatterplot not being
...
better visualizations through the use of a simple, reproducible
framework.
...
saw each combination of size and contrast decay function plots for a
...
inverted contrast decay functions produced the least accurate estimates
...
\item
  ...
  isolation, as here it produces the most accurate estimates.
\item
...
been smoothed. Errorbars have not been}
...
there are a multitude of parameters that could be adjusted for each
