...
The testing of correlation perception has a long and rich history. Very
early work had participants make discriminative judgements between
scatterplots with different correlations \citep{pollack_1960}, finding
that performance on such a task became better as the objective \emph{r}
value increased. Work
...
\tightlist
\item
  width of perceived prob distribution
\item
  shape of prediction ellipse
\item
...
studies using Prolific, and were required to have a prolific score of at
least 100, representing a 99\% approval rate. This is more strict than
the 95\% suggestedin previous work \citep{peer_2021}, but
...
with that of previous work {[}\citet{strain_2023}; strain\_2023b{]}.
