...
opacity points had very low visibility. We therefore implemented an
...
of the screen. We used equation 1 to map residuals to size and opacity
values:
...
size or opacity The present study opens the door for this future work,
as it provides the necessary additional data to previous experiments
using only size \citep{strain_2023b} or opacity \citep{strain_2023}
